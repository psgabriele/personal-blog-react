    ...
    return(
        <Container maxWidth="sm" className="topo">
             <form>
                ...
                <TextField id="titulo" label="título" value="" variant="outlined" name="titulo" margin="normal" fullWidth />
                <TextField id="texto" label="texto" value="" variant="outlined" name="texto" margin="normal" fullWidth />
